...
class PathFinder:
    """
    Class for generating a graph from a point cloud,
    finding connected components, and computing paths
    that ensure consecutive points are within a maximum distance.
    """

    def __init__(self, points, max_distance):
        """
    ...
    def _create_graph(self):
        """
        Creates a graph where nodes are points and edges connect
        points within the max_distance limit.
    ...
    def find_connected_components(self):
        ...
        :return: List of lists containing point indices in each connected component
        """
        return [list(component) for component in nx.connected_components(self.graph)]
    
    def _solve_path(self, points):
        """
        Finds paths within a connected component, ensuring that consecutive points
        respect the distance constraint.
        
        :param points: List of tuples representing (x, y, z) coordinates
        :return: List of paths, each path being a list of (x, y, z) tuples
        """
...
def main():
    ...
    points_all = [point[0] for point in points] # Extracting (x, y, z) coordinates from the point cloud [(x, y, z), (r, g, b)]
